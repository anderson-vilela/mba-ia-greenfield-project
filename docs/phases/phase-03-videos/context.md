...
sources_mtime:
  ...
  docs/decisions/technical-decisions-openapi-docs-nestjs.md: "2026-09-05T11:46:56-03:00"
  docs/phases/phase-01-configuracao-base/context.md: "2026-09-05T11:46:56-03:00"
  docs/phases/phase-02-auth/context.md: "2026-09-05T11:46:56-03:00"
  docs/phases/phase-02-auth-frontend/context.md: "2026-09-05T11:46:56-03:00"
...
**Affected subprojects:** _Not specified._ No subproject path (`nestjs-project`, `next-frontend`) is explicitly named in the Fase 03 block of `docs/project-plan.md`.
...
|-----|--------|-------|-------|--------|----------|-----------|------------|
| phase-03-videos/TD-01 | phase | Backend | Background Processing Queue Technology | decided | A | bullmq, @nestjs/bullmq | — |
| phase-03-videos/TD-02 | phase | Backend | 10GB Upload Strategy | decided | A | @aws-sdk/client-s3, @aws-sdk/s3-request-presigner | — |
| phase-03-videos/TD-03 | phase | Backend | Upload Completion Contract & Processing Trigger | decided | A | — | — |
| phase-03-videos/TD-04 | phase | Backend | Local S3-Compatible Storage Image | decided | A | — | — |
| phase-03-videos/TD-05 | phase | Backend | Bucket & Key Organization | decided | B | — | — |
| phase-03-videos/TD-06 | phase | Backend | Video Worker Packaging & Runtime | decided | A | — | — |
| phase-03-videos/TD-07 | phase | Backend | Media Toolchain for Metadata Extraction & Thumbnail Gen… | decided | A | — | — |
| phase-03-videos/TD-08 | phase | Backend | Unique Video URL Identifier Strategy | decided | B | — | — |
| phase-03-videos/TD-09 | phase | Backend | Video Streaming Delivery Strategy | decided | A | — | — |
| phase-03-videos/TD-10 | phase | Backend | Video Download Delivery | decided | A | — | — |
| phase-03-videos/TD-11 | phase | Backend | Video Status Lifecycle & Processing Failure Policy | decided | A | — | — |
| phase-03-videos/TD-12 | phase | Backend | Upload Validation & Limits Policy | decided | A | — | — |
| phase-03-videos/TD-13 | phase | Backend | Test Isolation Strategy for Storage & Queue Infrastructure | decided | A | — | — |
...
|-----------------------------------|------------|
| Serviço de armazenamento de arquivos (vídeos e thumbnails) | phase-03-videos/TD-04, phase-03-videos/TD-05, phase-03-videos/TD-13 |
| Serviço de processamento em segundo plano (filas) | phase-03-videos/TD-01, phase-03-videos/TD-06, phase-03-videos/TD-13 |
...
| Pré-cadastro automático do vídeo como rascunho ao iniciar o upload | phase-03-videos/TD-03, phase-03-videos/TD-11 |
| Processamento automático do vídeo após upload (extração de duração e metadados) | phase-03-videos/TD-03, phase-03-videos/TD-06, phase-03-videos/TD-07, phase-03-videos/TD-11 |
...
- Config is injected into modules via `ConfigType<typeof xxxConfig>` and `@Inject(xxxConfig.KEY)`; the same factory is importable as a plain function for... _(from phase 01)_
